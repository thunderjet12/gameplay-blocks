...
$load = gameplay_blocks_should_load_wpemerge( $name, '0.16.0', '2.0.0' );

if ( ! $load ) {
	// An incompatible WP Emerge version is already loaded - stop further execution.
	// gameplay_blocks_should_load_wpemerge() will automatically add an admin notice.
	return;
}

define( 'GAMEPLAY_BLOCKS_PLUGIN_FILE', __FILE__ );
...
gameplay_blocks_declare_loaded_wpemerge( $name, 'theme', __FILE__ );

// Load helpers.
require_once __DIR__ . DIRECTORY_SEPARATOR . 'app' . DIRECTORY_SEPARATOR . 'src' . DIRECTORY_SEPARATOR . 'GameplayBlocks.php';
...
\GameplayBlocks::make()->bootstrap( require __DIR__ . DIRECTORY_SEPARATOR . 'app' . DIRECTORY_SEPARATOR . 'config.php' );
